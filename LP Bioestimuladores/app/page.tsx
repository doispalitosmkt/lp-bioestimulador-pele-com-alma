...
export const metadata: Metadata = {
  ...
  description:
    "Avalio a sua pele e explico se o bioestimulador de colágeno faz sentido para você. Dra. Paula Sian, dermatologista em São Paulo.",
};
...
const faqs = [
  ["Dói? E quanto tempo pode durar?", "Pode haver desconforto na aplicação. Converso sobre formas de reduzi-lo e explico o que esperar. Com alguns produtos, o efeito pode chegar a cerca de dois anos, mas a duração varia e não é uma promessa para todos os casos."],
  ["Em quanto tempo percebo o resultado?", "Explico que o efeito é gradual e costuma evoluir ao longo de semanas e meses. O ritmo depende da sua pele e do plano de tratamento."],
  ["Quantas sessões vou precisar?", "Defino o número de sessões e os intervalos depois de examinar a sua pele. Não trabalho com uma quantidade igual para todas as pessoas."],
  ["Bioestimulador vai deixar meu rosto inchado?", "Bioestimulador e preenchimento têm objetivos diferentes. Avalio se a sua queixa pede estímulo de colágeno, reposição de volume ou outro cuidado."],
  ["Emagreci com caneta e meu rosto mudou. Ele é indicado?", "A perda de peso, inclusive com medicações, pode mudar o aspecto do rosto. Avalio a flacidez, a anatomia e o momento do emagrecimento antes de indicar qualquer tratamento."],
];
    ...
    <main>
      ...
      <section className="hero" id="inicio">
        ...
        <div className="container hero-grid">
          <div className="hero-copy">
            ...
            <p className="hero-lede">Antes de indicar qualquer procedimento, escuto sua história e avalio o que a sua pele precisa.</p>
      ...
      <section className="concern-section" id="incomoda">
        <div className="container concern-grid">
          <div className="concern-content"><p className="eyebrow">Antes do procedimento, vem a escuta</p><h2>O que te incomoda?</h2><p className="section-intro">Essa é uma das primeiras perguntas que faço na consulta. Quero entender a sua queixa antes de pensar em um procedimento.</p><div className="concern-list">{concerns.map((concern) => <div className="concern-item" key={concern}><span className="check" aria-hidden="true">✓</span><span>{concern}</span></div>)}<p className="concern-footnote">Se você se reconheceu em alguma dessas situações, posso avaliar o seu caso.</p></div></div>
          <PaulaVideo number={4} topic="em quais casos o bioestimulador pode ser indicado" className="concern-video" />
        </div>
      </section>

      <section className="education-section">
        <div className="container"><div className="education-intro"><div className="section-heading"><p className="eyebrow">Informação para decidir com calma</p><h2>O que é o bioestimulador de colágeno?</h2><p className="section-intro">Explico o bioestimulador como um tratamento injetável que estimula a produção de colágeno. Seu efeito é gradual. Ele não é a mesma coisa que um preenchimento.</p></div><figure className="education-photo"><Image src="/images/avaliacao-pele-pexels.jpg" alt="Profissional de saúde examinando a pele do rosto de uma mulher" width={1125} height={750} /></figure></div>
          <div className="education-cards">
            <article className="education-card"><span className="card-kicker">Quando considero</span><h3>Firmeza e qualidade da pele</h3><p>Avalio flacidez e perda de sustentação, inclusive quando o rosto muda após emagrecimento com medicações.</p></article>
            <article className="education-card featured-card"><span className="card-kicker">O que acontece</span><h3>Estímulo gradual</h3><p>Explico que o organismo produz colágeno ao longo do tempo. A evolução e a resposta variam de pessoa para pessoa.</p></article>
            <article className="education-card"><span className="card-kicker">Como escolho</span><h3>Produto e sessões para você</h3><p>Avalio a área, a anatomia e os seus objetivos para definir o produto e o número de sessões. Não existe um protocolo único.</p></article>
          </div>
        </div>
      </section>
      ...
      <section className="procedure-section" id="procedimento">
        <div className="container">
          <div className="section-heading procedure-heading">
            ...
            <p className="section-intro">Primeiro, entendo a sua queixa e examino a pele. Se o bioestimulador for indicado, explico o produto, a técnica e os cuidados antes de começarmos.</p>
          </div>
          <div className="procedure-grid">
            <figure className="procedure-image-card">
              ...
              <figcaption><span>Primeiro passo</span><strong>Escuta e avaliação</strong><small>Começo pelo que você percebe na sua pele.</small></figcaption>
            </figure>
            <figure className="procedure-image-card">
              <Image src="/images/aplicacao-suave-pexels.jpg" alt="Mulher durante um atendimento estético facial" width={500} height={750} />
              <figcaption><span>Quando indicado</span><strong>Aplicação planejada</strong><small>Explico o que será feito e acompanho a evolução.</small></figcaption>
            </figure>
          </div>
        </div>
      </section>
      ...
      <section className="doctor-video-section" id="video-dra-paula">
        <div className="container video-grid">
          <div className="video-copy">
            ...
            <h2>Analiso cada caso, sem seguir uma receita pronta.</h2>
      ...
      <section className="comparison-section">
        <div className="container comparison-grid">
          <div className="comparison-copy">
            ...
            <p className="section-intro">Posso considerar os dois em um plano de cuidado, mas eles cumprem funções diferentes. Primeiro avalio; depois explico as opções.</p>
          </div>
      ...
      <section className="method-section"><div className="container"><div className="method-heading"><p className="eyebrow">Como funciona comigo</p><h2>Da primeira conversa ao acompanhamento.</h2><p className="section-intro">Examino sua pele antes de indicar qualquer tratamento. Assim, você entende o motivo de cada decisão.</p></div><div className="method-grid"><div className="method-image-wrap"><Image src="/images/paula-consultorio-oficial.jpg" alt="Dra. Paula Sian em seu consultório" width={749} height={560} className="method-image" /></div><div className="method-copy"><div className="steps"><div className="step"><span>01</span><div><h3>Escuto e examino</h3><p>Conversamos sobre suas queixas, seu momento e o que você deseja mudar.</p></div></div><div className="step"><span>02</span><div><h3>Explico o plano</h3><p>Apresento as possibilidades e digo com clareza quando o bioestimulador não é a melhor escolha.</p></div></div><div className="step"><span>03</span><div><h3>Acompanho a evolução</h3><p>Se decidirmos pelo tratamento, sigo com você nas etapas e reavaliações.</p></div></div></div><WhatsAppButton /></div></div></div></section>
        ...
        <div className="container">
          ...
          <div className="services-block">
            ...
            <div className="services-grid">
              <article className="service-card"><Image src="/images/service-acne.webp" alt="Rosto de uma mulher em close" width={800} height={600} /><div className="service-copy"><span>Dermatologia clínica</span><h4>Acne e cicatrizes</h4><p>Avalio a origem e monto um cuidado adequado à sua pele.</p></div></article>
              <article className="service-card"><Image src="/images/service-pigmentacao.webp" alt="Rosto de uma mulher com sardas" width={800} height={600} /><div className="service-copy"><span>Pigmentação</span><h4>Manchas e melasma</h4><p>Considero sua rotina e a resposta da pele ao planejar o cuidado.</p></div></article>
              <article className="service-card"><Image src="/images/service-cabelo.webp" alt="Aplicação de sérum no couro cabeludo" width={800} height={600} /><div className="service-copy"><span>Saúde capilar</span><h4>Queda de cabelo</h4><p>Investigo possíveis causas antes de propor um tratamento.</p></div></article>
              <article className="service-card"><Image src="/images/avaliacao-pele-pexels.jpg" alt="Profissional examinando a pele de uma mulher" width={1125} height={750} /><div className="service-copy"><span>Dermatologia cirúrgica</span><h4>Lesões de pele</h4><p>Examino e explico quando um procedimento pode ser necessário.</p></div></article>
              <article className="service-card"><Image src="/images/consulta-espelho-pexels.jpg" alt="Mulher observando a pele no espelho" width={500} height={750} /><div className="service-copy"><span>Prevenção</span><h4>Saúde da pele</h4><p>Acompanho sua pele também fora dos procedimentos estéticos.</p></div></article>
            </div>
          </div>
        </div>
      </section>
